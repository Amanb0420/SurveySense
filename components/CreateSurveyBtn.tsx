...
import CreateSurveyBtnAi from "./CreateSurveyBtnAi";
    ...
    <Dialog>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>Create a new survey to start collecting responses</DialogDescription>
        </DialogHeader>
        <Form {...form}>
        ...
        <DialogFooter>
          <Button onClick={form.handleSubmit(onSubmit)} disabled={form.formState.isSubmitting} className=" mt-4">
